...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Generate axactly number of quiz questions users request. Based on the following paragraph.Try to make some general knowledge questions. Each question should have the following structure:
    {
    ...
    if (
      ...
      return NextResponse.json({
        error:
          "Generated quiz questions did not have the required fields or structure.",
      });
    }

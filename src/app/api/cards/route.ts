...
export async function POST(req: NextRequest) {
  try {
    ...
    {
      "question": "Question text. Make sure question is not too long or too short. Question should be in the same language as the paragraph. Level of question should be easy to hard.",
      "answer": "Answer text. Make sure answer is not too long or too short. Answer should be in the same language as the paragraph.",
      "explanation": "Explanation of answer detail based on data. Make sure explanation is not too long or too short. Explanation should be in the same language as the paragraph."
    }

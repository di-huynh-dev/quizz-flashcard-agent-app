...
const FlashcardGenerator = () => {
  ...
  useCopilotReadable({
    ...
    value:
      " It generate the cards on the specific topic given by the user.It have question and answer along with explanation.",
  });
  ...
  const generateFlashcards = async () => {
    if (wordCount < 50) {
      setError("Please enter at least 50 words to generate flashcards.");
      return;
    }
    ...
    <div>
      <div className="max-w-4xl mx-auto p-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-white">AI Flashcard Generator</h2>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-3 right-3 text-sm text-gray-800">
                ...
                {wordCount < 150 && wordCount > 0 && (
                  <span className="text-amber-500">({150 - wordCount} more words needed)</span>
                )}
          ...
          <div className="px-10 ">
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="text-2xl font-semibold text-white">Generated Flashcards</h3>
                <p className="text-white">{flashcards.length} cards created</p>
              </div>

...
const QuizGenerator = () => {
  ...
  useCopilotReadable({
    ...
    value:
      " It generate the quiz on the specific topic given by the user.It have 4 options and also count time needed for it to complete.",
  });
      ...
      {showQuiz && quizQuestions && quizQuestions.length > 0 ? (
        ...
        !loading && (
          <p className="text-gray-500 mt-4">
            No questions generated. Please try again with different text.
          </p>
        )
      )}
    </div>
